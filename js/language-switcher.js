const translations = {
  en: {
    ...
    "hero-text": "Book your medical appointment online simply and quickly.",
    "book-now": "Book Now",
    ...
    "step1-title": "Choose Specialist",
    "step1-desc": "Browse our list of doctors and choose the right specialist for your needs.",
    "step2-title": "Choose Date and Time",
    "step2-desc": "Select a date and time that suits you from available schedules.",
    "step3-title": "Confirm Reservation",
    "step3-desc": "Fill in your details and confirm your appointment.",
    ...
    "testimonial2-text": "\"Doctors are very careful and attentive. I recommend this clinic to everyone.\"",
    ...
    "cardiology-full-desc": "Our Cardiology Department offers complete diagnosis and treatment for a wide range of cardiovascular diseases. Our services include:",
    "cardiology-service-1": "Complete cardiac examinations",
    "cardiology-service-2": "Electrocardiograms (ECG)",
    "cardiology-service-3": "Echocardiography",
    "cardiology-service-4": "Stress test",
    "cardiology-service-5": "Holter monitoring",
    "cardiology-service-6": "Heart disease prevention counseling",
    "neurology-full-desc": "Our Neurology Department offers diagnosis and treatment for nervous system disorders. Our services include:",
    "neurology-service-1": "Complete neurological examinations",
    ...
    "dentistry-full-desc": "Our Dentistry Department offers a complete range of dental services for the whole family. Our services include:",
    "dentistry-service-1": "Routine check-ups and cleaning",
    ...
    "ophthalmology-full-desc": "Our Ophthalmology Department offers complete eye health care. Our services include:",
    "ophthalmology-service-1": "Complete eye examinations",
    ...
    "insurance-contact": "For more information about insurance coverage, please <a href=\"contact.html\">contact us</a>.",
    "make-reservation": "Make an Appointment",
    ...
    "confirm-reservation": "Confirm Appointment",
    "reservation-info": "Appointment Information",
    "reservation-info-text": "After confirming your appointment, you will receive a confirmation email with your appointment details. Please arrive 15 minutes before your scheduled time.",
    "need-help": "Need help?",
    "contact-us-page": "Contact Us",
    "contact-info-title": "Contact Information",
    "address-title": "Address",
    "address-full": "Durrës Street, No. 123, Tirana, Albania",
    "phone-title": "Phone",
    "email-title": "Email",
    ...
    "chatbot-welcome": "Hello! How can I help you today with your appointment?",
    "type-message": "Type your message...",
    "footer-desc": "Your trusted platform for online medical appointments.",
    "quick-links": "Quick Links",
    "contact-us": "Contact Us",
    "address": "Durrës Street, Tirana, Albania",
  ...
  sq: {
    ...
    "testimonial2-author": "- Elona Hoxha",
    "meet-our-specialists": "Njihuni me Specialistët Tanë",
    "book-appointment": "Rezervo Takim",
    "our-doctors": "Mjekët Tanë",
    "our-services-page": "Shërbimet Tona",
    ...
    "insurance-contact": "Për më shumë informacion mbi mbulimin e sigurimit, ju lutemi <a href=\"contact.html\">na kontaktoni</a>.",
...
function initLanguage() {
  const savedLang = localStorage.getItem('medreserve-lang') || (navigator.language.startsWith('sq') ? 'sq' : 'en');
...
function switchLanguage(lang) {
  localStorage.setItem('medreserve-lang', lang);
...
document.getElementById('lang-sq').addEventListener('click', () => switchLanguage('sq'));
